...
const Header = ({ workspaceId }) => {
  ...
  return (
    <header className="flex items-center justify-between px-8 py-3 bg-[#0a0f1e] bg-opacity-80 backdrop-blur-lg border-b border-gray-700 shadow-xl z-20">
      ...
      <h1 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-500 drop-shadow-lg animate-pulse">
      ⚡ Code Cript - AI Powered Code Editor
      </h1>
